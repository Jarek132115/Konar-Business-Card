          ...
          {mobileOpen && (
            <>
              ...
              <div className="auth-links">
                <Link to="/login" className="btn login-btn" onClick={() => setMobileOpen(false)}>Login</Link>
                <Link to="/register" className="btn signup-btn" onClick={() => setMobileOpen(false)}>Sign up</Link>
              </div>
            </>
          )}
        </div>
