      ...
      <div style={{ marginTop: 40 }} className='section'>
        ...
        <form className='contact-form'>
          <div className='contact-input-container'>
            <label className='desktop-body'>Name *</label>
            <input
              type='text'
          ...
          <div className='contact-input-container'>
            <label className='desktop-body'>Email *</label>
            <input
              type='text'
          ...
          <div className='contact-input-container-message'>
            <label className='desktop-body message-box'>Message *</label>
          ...
          <Link style={{ textAlign: 'center' }} to="/login" className="blue-button desktop-button">Send Message</Link>
