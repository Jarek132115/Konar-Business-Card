...
import Section2Image from '../../assets/images/Section-2-Image.png'
...
import MetalCard from '../../assets/images/MetalCard.png'
          ...
          <div className="subscription-div">
            ...
            <div className="subscription-info">
              <div className="hero-tick-container-down">
                ...
                <div className="hero-tick">
                  <img src={TickIcon} className="icon" />
                  <p>Choose between light or dark background</p>
                </div>
                <div className="hero-tick">
                  <img src={TickIcon} className="icon" />
                  <p>Pick a font that fits your style</p>
                </div>
                <div className="hero-tick">
                  <img src={TickIcon} className="icon" />
                  <p>Show your name, job title, and profile photo</p>
                ...
                <div className="hero-tick">
                  <img src={TickIcon} className="icon" />
                  <p>Upload photos of your best work</p>
                </div>
                <div className="hero-tick">
                  <img src={TickIcon} className="icon" />
                  <p>List your services and prices clearly</p>
                </div>
                <div className="hero-tick">
                  <img src={TickIcon} className="icon" />
                  <p>Add reviews from happy customers</p>
                </div>
                <div className="hero-tick">
                  <img src={TickIcon} className="icon" />
