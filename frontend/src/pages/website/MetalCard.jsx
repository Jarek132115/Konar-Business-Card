...
import MetalCards from '../../assets/images/MetalCard.png';
    ...
    <>
      ...
      <div style={{ marginTop: 40 }} className="section-product">
        ...
        <div className="product-preview">
          <img src={MetalCards} alt="Main Card" className="main-card" />
          <div className="thumbnail-row">
            <img src={MetalCards} alt="Thumbnail 1" className="thumbnail" />
            <img src={MetalCards} alt="Thumbnail 2" className="thumbnail" />
            <img src={MetalCards} alt="Thumbnail 3" className="thumbnail" />
            <img src={MetalCards} alt="Thumbnail 4" className="thumbnail" />
            <img src={MetalCards} alt="Thumbnail 5" className="thumbnail" />
          </div>
        </div>

        {/* Right Section - Options */}
        <div className="product-options">
          <p className='desktop-h5'>Metal NFC Business Card</p>
          ...
          <p style={{ fontSize: 18, fontWeight: 600, marginTop: 10, marginBottom: 20 }}>£49.95</p>
